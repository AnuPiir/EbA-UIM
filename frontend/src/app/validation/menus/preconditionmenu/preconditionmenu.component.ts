...
@Component({
  selector: 'app-preconditionmenu',
  templateUrl: './preconditionmenu.component.html',
  styleUrls: ['./preconditionmenu.component.css']
})
export class PreconditionmenuComponent {

  @Input() onAddPrecondition: () => void;
  @Input() onDeletePrecondition: () => void;
  ...
  handleAddPrecondition(): void {
    this.onAddPrecondition();
    this.closeMenu();
  }

  handleDeletePrecondition(): void {
    this.onDeletePrecondition();
    this.closeMenu();
  }
